...
public class frag_register extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnRegister=view.findViewById(R.id.regSignUpButton);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mainActivity.RegisterFunc();
                Navigation.findNavController(getView()).navigate((R.id.action_frag_register_to_frag_login));
            }
        });
        return view;
    }
